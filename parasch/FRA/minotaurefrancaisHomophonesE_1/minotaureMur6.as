...
function mur(objetCase, orientation)
{
	...
	switch (orientation)
	{
		...
		this["murHAUT"+no].lineTo(rapportLongLarg*coteCase-4, -3);
		this["murHAUT"+no].lineTo(rapportLongLarg*coteCase-4, 1);
		this["murHAUT"+no].lineTo(2, 1);
		this["murHAUT"+no].lineTo(2, -3);
		this["murHAUT" + no].endFill;
		this["murHAUT"+no]._x = rapportLongLarg*coteCase * (posX-1) + marge;//posX-1 pour commencer à(0;0)
		...
		this["murBAS"+no].lineTo(rapportLongLarg*coteCase-4, coteCase-3);
		this["murBAS"+no].lineTo(rapportLongLarg*coteCase-4, coteCase+1);
		this["murBAS"+no].lineTo(2, coteCase+1);
		this["murBAS"+no].lineTo(2, coteCase-3);
		this["murBAS" + no].endFill;
		this["murBAS"+no]._x = rapportLongLarg*coteCase * (posX-1) + marge;//posX-1 pour commencer à(0;0)
		...
		this["murGAUCHE"+no]._x =rapportLongLarg * coteCase * (posX-1) + marge;//posX-1 pour commencer à(0;0)
		...
		this["murDROITE"+no].moveTo(rapportLongLarg *coteCase-3, 2);
		this["murDROITE"+no].lineTo(rapportLongLarg *coteCase-3, coteCase-4);
		this["murDROITE"+no].lineTo(rapportLongLarg *coteCase+1, coteCase-4);
		this["murDROITE"+no].lineTo(rapportLongLarg *coteCase+1, 2);
		this["murDROITE"+no].lineTo(rapportLongLarg *coteCase-3, 2);
		this["murDROITE" + no].endFill;
		this["murDROITE"+no]._x = rapportLongLarg * coteCase * (posX-1)+ marge ;//posX-1 pour commencer à(0;0)
