...
function fil(objetCase,type,orientation)
{
	...
	switch (orientation)
	{
		...
		this["filHAUT"+no]._x = decalage+rapportLongLarg*coteCase * (posX-0.5) + marge ;//posX-1 pour commencer à(0;0)
		...
		this["filBAS"+no]._x = decalage+rapportLongLarg*coteCase * (posX-0.5) + marge;//posX-1 pour commencer à(0;0)
		...
		this["filGAUCHE"+no].lineTo(-rapportLongLarg*coteCase, 0);
		this["filGAUCHE"+no]._x = decalage+rapportLongLarg*coteCase * (posX-0.5) + marge;//posX-1 pour commencer à(0;0)
		...
		this["filDROITE"+no].lineTo(rapportLongLarg*coteCase, 0);
		this["filDROITE"+no]._x = decalage+rapportLongLarg*coteCase * (posX-0.5) + marge;//posX-1 pour commencer à(0;0)
