...
//	public var affichageB:MovieClip;
	...
	private var matailleX:Number; //longueur de la case
	private var matailleY:Number; //hauteur de la case
	private var active:Boolean = false;//Si la case peut ètre active en fonction du chemin
	private var monFormat:TextFormat;
	private var rapport:Number;
	...
	function minotaureCase6(taille,rapportTemp, positionX, positionY, margeGrille, bordure, clipConteneur, formatTemp)
	{
		rapport = rapportTemp;
		monFormat = formatTemp;
		matailleX = taille * rapport;
		matailleY = taille;
		posX = positionX;
		posY = positionY;
		marge = margeGrille;
	...
	function dessine()
	{
		...
		conteneur.carre.lineTo(matailleX-2, 0);
		conteneur.carre.lineTo(matailleX-2, matailleY-2);
		conteneur.carre.lineTo(0, matailleY-2);
		conteneur.carre.lineTo(0, 0);
		conteneur.carre.endFill;
		conteneur.carre._x = matailleX * (posX-1) + marge;//posX-1 pour commencer à(0;0)
		conteneur.carre._y = matailleY * (posY - 1) + marge;
		conteneur.createEmptyMovieClip("tourCaseJuste", 11111);
		conteneur.tourCaseJuste.lineStyle(6, 0x777700);
		conteneur.tourCaseJuste.lineTo(matailleX-2, 0);
		conteneur.tourCaseJuste.lineTo(matailleX-2, matailleY-2);
		conteneur.tourCaseJuste.lineTo(0, matailleY-2);
		conteneur.tourCaseJuste.lineTo(0, 0);
		conteneur.tourCaseJuste._x = matailleX * (posX-1) + marge;//posX-1 pour commencer à(0;0)
		conteneur.tourCaseJuste._y = matailleY * (posY - 1) + marge;
		...
		conteneur.tourCaseFaux.lineTo(matailleX-2, 0);
		conteneur.tourCaseFaux.lineTo(matailleX-2, matailleY-2);
		conteneur.tourCaseFaux.lineTo(0, matailleY-2);
		conteneur.tourCaseFaux.lineTo(0, 0);
		conteneur.tourCaseFaux._x = matailleX * (posX-1) + marge;//posX-1 pour commencer à(0;0)
		conteneur.tourCaseFaux._y = matailleY * (posY - 1) + marge;
...
//		}
		//leFormat.color=Number(0xFFFFFF)-Number(couleurFond);
		//conteneur.carre.createTextField("val1", 10, 5 , 5, matailleX/2, matailleY);
		conteneur.carre.createTextField("val1", 10, 5 , 5, matailleX-10, matailleY+40);
		//conteneur.carre.val1.embedFonts=true;
		conteneur.carre.val1.selectable = false;
		conteneur.carre.val1.multiline = true;
		conteneur.carre.val1.wordWrap = true;
...
//		}
		...
		//conteneur.carre.createTextField("val2", 11, 5 , matailleY*39/64, matailleX-10, matailleY*3/16+4);
		conteneur.carre.createTextField("val2", 11, 5 , matailleY*39/70, matailleX-10, matailleY+40);
		//conteneur.carre.val2.embedFonts=true;
		conteneur.carre.val2.setNewTextFormat(leFormat);
		conteneur.carre.val2.selectable = false;
		conteneur.carre.val2.multiline = true;
		conteneur.carre.val2.wordWrap = true;
		...
		switch (position)
		{
			...
			switch (operationUtiliseeH)
			{
				...
				case ("developpe"):
					...
					developpeH=true;
					conteneur.carre.monAffichageDeveloppeHaut.createTextField("degre2Dev", 1, 0, 0, 0, 20);
					...
					conteneur.carre.monAffichageDeveloppeHaut.createTextField("exposantDev",2, 21, -5, 15, 15);
					...
					conteneur.carre.monAffichageDeveloppeHaut.createTextField("degre1Dev", 3, 26, 0, 50, 20);
				...
				case ("factorise"):
					...
					conteneur.carre.monAffichageFactoriseHaut.createTextField("factorise", 1, (matailleX-30)/2, 0, 0, matailleX*3/16+4);
					...
					conteneur.carre.monAffichageFactoriseHaut.createTextField("exposantFact",2, (matailleX-10)*7/10, -5, 15, 15);
					var tailleCaractere:Number=ceFormat.size;
					ceFormat.size=tailleCaractere*2/3;
					ceFormat.align = "left";
		...
		case("BAS"):
			...
			switch(operationUtiliseeB)
			{
				case ("developpe"):
					...
					conteneur.carre.monAffichageDeveloppeBas._y=matailleY*39/64;
					developpeH=false;
					conteneur.carre.monAffichageDeveloppeBas.createTextField("degre2Dev", 1, 0, 0, 25, 20);
					...
					conteneur.carre.monAffichageDeveloppeBas.createTextField("exposantDev",2, 21, -5, 15, 15);
					...
					conteneur.carre.monAffichageDeveloppeBas.createTextField("degre1Dev", 3, 26, 0, 50, 20);
				...
				case ("factorise"):
					...
					conteneur.carre.monAffichageFactoriseBas._y=matailleY*39/64;
					factoriseH=false;
					conteneur.carre.monAffichageFactoriseBas.createTextField("factorise", 1, 0, 0, matailleY-10, matailleX*3/16+4);
					...
					conteneur.carre.monAffichageFactoriseBas.createTextField("exposantFact",2, (matailleX-10)*3/4, -5, 15, 15);
					...
					switch (true)
					{
						...
						conteneur.carre.monAffichageFactoriseBas.exposantFact.text="";
							...
							if(d>0)
							{
								conteneur.carre.monAffichageFactoriseBas.factorise.text=conteneur.carre.monAffichageFactoriseBas.factorise.text+"("+a+"x+"+b+")";
							}else if (d<0)
							{
								conteneur.carre.monAffichageFactoriseBas.factorise.text=conteneur.carre.monAffichageFactoriseBas.factorise.text+"("+a+"x"+b+")";
							}
