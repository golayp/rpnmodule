...
tabForme = ["J'ai gagn__ !", "Vous ven__ ?", "Je viendr__ demain.", "Il faudr__ que tu m'aides.", "J'ai envie de progress__", "Tu pourr__ m'aider ?", 
			"Qui va gagn__ ?", "Je ne pourr__ jamais faire ça !", "Pouv__-vous me répondre ?", "Il s'est fait félicit__.", "En 2009, il all__ souvent à Bâle.", 
			"Tu as remarqu__ l'erreur ?", "Tu pourr__ me passer le sel ?", "Demain, j'ir__ au cinéma.", "Elle a falsifi__ ses notes !", "Vous réussir__ facilement !", 
			"Il sembler__ que ça soit vrai.", "J'espère rêv__ de vacances cette nuit !", "Si je sav__ quoi faire, je le ferais !", "Pens__-vous que j'ai raison ?", 
			"Il ador__ ça autrefois !", "Je partir__ dès la sonnerie !", "Nous avons cré__ un groupe rock.", "Je voudr__ venir, mais je ne peux pas."];
trace("tabForme.length"+tabForme.length);
//Initialisation du tableau contenant les formes justes
var tabFormeJuste : Array;

tabFormeJuste = ["gagné", "venez", "viendrai", "faudrait", "progresser", "pourrais", "gagner", "pourrai", "pouvez", "féliciter", "allait", "remarqué", 
				 "pourrais", "irai", "falsifié", "réussirez", "semblerait", "rêver", "savais", "pensez", "adorait", "partirai", "créé", "voudrais"];
...
tabFormeFausse = ["gagner", "venai", "viendrais", "faudrais", "progressé", "pourrait", "gagné", "pourrait", "pouvai", "félicité", "allais", "remarquer", 
				  "pourrait", "irez", "falsifier", "réussirai", "semblerais", "rêvé", "savait", "penser", "adorais", "partirais", "créer", "voudrai"];
...
tabCommentaires = ["Essaie de remplacer par mordre ou mordu !", "Cherche le sujet !", "C'est un verbe au futur !", "Cherche le sujet !", 
				   "Essaie de remplacer par mordre ou mordu !", "Cherche le sujet !", "Essaie de remplacer par mordre ou mordu !", 
				   "Cherche le sujet !", "Cherche le sujet !", "Essaie de remplacer par mordre ou mordu !", "Cherche le sujet !", 
				   "Essaie de remplacer par mordre ou mordu !", "Cherche le sujet !", "Cherche le sujet !", "Essaie de remplacer par mordre ou mordu !", 
				   "Cherche le sujet !", "Cherche le sujet !", "Essaie de remplacer par mordre ou mordu !", "Cherche le sujet !", "Cherche le sujet !", 
				   "Cherche le sujet !", "C'est un verbe au futur !", "Essaie de remplacer par mordre ou mordu !", "C'est un verbe au conditionnel !"];
