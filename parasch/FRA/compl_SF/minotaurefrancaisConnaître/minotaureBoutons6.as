...
fondMc.attachMovie("btnVerifier", "verifie_Btn", 10000);
fondMc.verifie_Btn._x = 600;
fondMc.verifie_Btn._y = 300;
fondMc.verifie_Btn._xscale = 90;
fondMc.verifie_Btn._yscale = 50;
fondMc.verifie_Btn._visible = false;
//Pour l'analyse non guidée, on met le "bouton vérifier" dans la case arrivée. On fait cela dans contenuChemin
