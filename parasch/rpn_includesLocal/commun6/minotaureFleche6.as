...
function fleche(objetCase,type,orientation)
{
	...
	switch (orientation)
	{
		...
		this["flecheHAUT"+no]._x = rapportLongLarg*coteCase * (posX-0.5)-0.125*coteCase + marge //posX-1 pour commencer à(0;0)
		...
		this["flecheBAS"+no]._x = rapportLongLarg*coteCase * (posX-0.5)-0.125*coteCase + marge //posX-1 pour commencer à(0;0)
		...
		this["flecheGAUCHE"+no]._x = rapportLongLarg*coteCase * (posX-1) + marge+0.05*coteCase;//posX-1 pour commencer à(0;0)
		...
		this["flecheDROITE"+no]._x = rapportLongLarg*coteCase * (posX) + marge -0.1*coteCase;//posX-1 pour commencer à(0;0)
