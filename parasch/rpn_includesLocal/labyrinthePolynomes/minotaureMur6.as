...
function mur(objetCase, orientation)
{
	...
	switch (orientation)
	{
		...
		this["murHAUT"+no]._x = (coteCase-3) * (posX-1) + marge;//posX-1 pour commencer à(0;0)
		...
		this["murBAS"+no]._x = (coteCase-3) * (posX-1) + marge;//posX-1 pour commencer à(0;0)
		...
		this["murGAUCHE"+no]._x = (coteCase-3) * (posX-1) + marge;//posX-1 pour commencer à(0;0)
		...
		this["murDROITE"+no]._x = (coteCase-3) * (posX-1) + marge;//posX-1 pour commencer à(0;0)
