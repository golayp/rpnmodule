...
function analyseGuide(ancienneCase, nouvelleCase)
{
	...
	//var resultatNouvelleCase:Number=resultatOperation(choixOperation,maCase[numeroNouvelleCase].nb1,maCase[numeroNouvelleCase].nb2);
	//trace("resultatNouvelleCase"+resultatNouvelleCase);
	//trace("resultatAncienneCase"+resultatAncienneCase);
...
//	var posDansTabAncienne:Number;
	...
	switch (true)
	{
		...
		break;
		case(maCase[numeroAncienneCase].nb1B==maCase[numeroNouvelleCase].nb1H && maCase[numeroAncienneCase].nb2B==maCase[numeroNouvelleCase].nb2H && maCase[numeroAncienneCase].nb3B==maCase[numeroNouvelleCase].nb3H && maCase[numeroAncienneCase].nb4B==maCase[numeroNouvelleCase].nb4H )://Si on a cliqué sur un nb premier plus petit,dans l'ordre décroissant c'est juste. On met juste dans le tableau des réponses
			//trace ("juste");
...
//						reperageFaux(reponseChemin);
		...
		break;
		case(maCase[numeroAncienneCase].nb1B!=maCase[numeroNouvelleCase].nb1H || maCase[numeroAncienneCase].nb2B!=maCase[numeroNouvelleCase].nb2H || maCase[numeroAncienneCase].nb3B!=maCase[numeroNouvelleCase].nb3H || maCase[numeroAncienneCase].nb4B!=maCase[numeroNouvelleCase].nb4H)://Si on n'a pas pris le nombre premier consécutif
		compteurFaux++;
