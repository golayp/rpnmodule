...
function fleche(objetCase,type,orientation)
{
	...
	switch (orientation)
	{
		...
		this["flecheHAUT"+no]._x = (coteCase-3) * (posX-1) + marge + 0.375*coteCase;//posX-1 pour commencer à(0;0)
		...
		this["flecheBAS"+no]._x = (coteCase-3) * (posX-1) + marge + 0.375*coteCase;//posX-1 pour commencer à(0;0)
		...
		this["flecheGAUCHE"+no]._x = (coteCase-3) * (posX-1) + marge + 0.1*coteCase;//posX-1 pour commencer à(0;0)
		...
		this["flecheDROITE"+no]._x = (coteCase-3) * (posX-1) + marge + 0.9*coteCase-2;//posX-1 pour commencer à(0;0)
