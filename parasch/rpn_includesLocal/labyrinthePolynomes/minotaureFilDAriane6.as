...
function fil(objetCase,type,orientation)
{
	...
	switch (orientation)
	{
		...
		this["filHAUT"+no]._x = decalage+(coteCase-3) * (posX-1) + marge + 0.5 * (coteCase-3);//posX-1 pour commencer à(0;0)
		...
		this["filBAS"+no]._x = decalage+(coteCase-3) * (posX-1) + marge + 0.5*(coteCase-3);//posX-1 pour commencer à(0;0)
		...
		this["filGAUCHE"+no].lineTo(-(coteCase-3), 0);
		this["filGAUCHE"+no]._x = decalage+(coteCase-3) * (posX-1) + marge + 0.5 * (coteCase-3);//posX-1 pour commencer à(0;0)
		...
		this["filDROITE"+no].lineTo((coteCase-3), 0);
		this["filDROITE"+no]._x = decalage+(coteCase-3) * (posX-1) + marge + 0.5 * (coteCase-3);//posX-1 pour commencer à(0;0)
