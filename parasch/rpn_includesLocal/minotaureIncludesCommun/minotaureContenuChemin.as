...
for (i = 2; i < longImpasse[longueurChemin]+1 ; i++)
{
	...
	trace("maCase[no].operationChoisie(choixOperation, tabHBJuste[posDepTab - i - 1][0], tabHBJuste[posDepTab - i - 1][1], texteBas_fmt)" +maCase[no].operationChoisie(choixOperation, tabHBJuste[posDepTab - longueurChemin + i][0], tabHBJuste[posDepTab - longueurChemin + i][1], texteBas_fmt) );
}
...
function testDoubleSorties()
{
	for (i = 0 ; i < longueurChemin ; i++)
	{
		...
		if (nbSuivant == nbVoisinH && etatCase[chemin[i][0]][chemin[i][1] - 1] != "chemin")
		{
			...
			//maCase[no].commentaireCase=tabHBJuste[posDepTab - i - 1][4];
			maCase[no].operationChoisie(choixOperation, tabHBJuste[posDepTab - i - 1][0], tabHBJuste[posDepTab - i - 1][1], texteBas_fmt);
			trace("maCase[no].operationChoisie(choixOperation, tabHBJuste[posDepTab - i - 1][0], tabHBJuste[posDepTab - i - 1][1], texteBas_fmt)" +maCase[no].operationChoisie(choixOperation, tabHBJuste[posDepTab - i - 1][0], tabHBJuste[posDepTab - i - 1][1], texteBas_fmt) );
		}
