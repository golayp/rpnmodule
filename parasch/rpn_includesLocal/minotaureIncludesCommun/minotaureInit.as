...
trace("aleaY"+aleaY);
trace("aleaX"+aleaX);
var couleurNombre:Number = 
	Math.ceil(aleaY) * Math.pow(16, alea[0]) + 
	Math.ceil(Math.random() * 5 + 10) * Math.pow(16, 4) + 
	Math.ceil(aleaX) * Math.pow(16, alea[1]) +
	Math.ceil(Math.random() * 5 + 10) * Math.pow(16, 2) + 
	Math.ceil(Math.random() * 5 + 10) * Math.pow(16, alea[2]) + 
...
var couleurDegrade:String = deciHexa(couleurNombre);
trace("couleurNombre" + Math.ceil(aleaY) * Math.pow(16, alea[0]) )
trace("couleurNombre" + Math.ceil(Math.random() * 5 + 10) * Math.pow(16, 4))
trace("couleurNombre" + Math.ceil(aleaX) * Math.pow(16, alea[1]) )
trace("couleurNombre" + Math.ceil(Math.random() * 5 + 10) * Math.pow(16, 2) )
trace("couleurNombre" + Math.ceil(Math.random() * 5 + 10) * Math.pow(16, alea[2]) )
trace("couleurNombre" + Math.ceil(Math.random() * 5 + 10) )
trace("")
trace ("couleurNombre"+ couleurNombre)
...
var couleurFlecheParcours:Number = 0x000000;//couleur de la flèche
...
function ecritureHexa(deci):String
{
