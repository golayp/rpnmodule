...
if(Math.round(monHeureDecimale*100)/100<=1){
	...
	maMontre.minuteATrouver = 0.6 * Math.floor((monHeureDecimale-monHeure) * 100);
}else {
	fondMc.fondTextMc.donneeDecimale.text = "Transforme " + monHeure + "," + (Math.floor((monHeureDecimale-monHeure) * 100)) + " heures\nen heures:minutes";
	maMontre.minuteATrouver = 0.6 * Math.floor((monHeureDecimale-monHeure) * 100);
}

//Si on demande les heures en code 1 décimale
if(Math.round(monHeureDecimale*100)/100<=1){
	fondMc.fondTextMc.donneeDecimale.text = "Transforme " + monHeure + "," + (Math.floor((monHeureDecimale-monHeure) * 10)) + " heure\nen heure:minutes";
	maMontre.minuteATrouver = 6 * Math.floor((monHeureDecimale-monHeure) * 10);
}else {
	fondMc.fondTextMc.donneeDecimale.text = "Transforme " + monHeure + "," + (Math.floor((monHeureDecimale-monHeure) * 10)) + " heures\nen heures:minutes";
	maMontre.minuteATrouver = 6 * Math.floor((monHeureDecimale-monHeure) * 10);
}
