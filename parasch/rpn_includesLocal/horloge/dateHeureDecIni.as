...
var maMontre:MovieClip = new dateHDec(posCentre[0], posCentre[1], fondMc.angleMc, texteValeurHAT_fmt, texteValeurMAT_fmt, texteValeurTxt_fmt, texteSolution_fmt, dateMontre_fmt, [450, 360]);
...
fondMc.fondTextMc.createTextField("typeAngleTxt", 1, posCentre[0]+180, posCentre[1]-170, 280, 140);
...
fondMc.fondTextMc.typeAngleTxt.text = "Quel est le nombre d'heures indiqué par la montre au dixième près?";
...
this.onEnterFrame = function() {
	...
	trace("maMontre.reponse: " + _level0.rep_juste);
	trace("maMontre.message: " + _level0.retour);
	trace("This: " + this);
}
