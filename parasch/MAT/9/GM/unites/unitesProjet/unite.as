...
clipLogo: création de logo lorsqu'on changera d'unité dans la deuxième activité
*/
...
public var drag:Boolean; //indique si le clip est en train d'être dragué
