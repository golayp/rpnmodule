...
class uniteAire extends MovieClip
{
...
public var lache:Boolean = false;//Indique si la souris est pressée ou pas
...
static var ceClip:MovieClip;
	...
	function uniteAire(tailleImageTemp, positionX, positionY,clipConteneur, utilisable, nomClipTemp)
	{
...
////////////////////////////ATTENTION ON NE PEUT PAS METTRE DE PNG DANS FLASH 6
		...
		rectangle(longueurBase, 1, 1, 2, 0x111111, 0x777777, 100);
	...
	function setTailleRectangle(maLongueur, X, Y)
	{
		rectangle(maLongueur, X, Y, 2, 0x111111, 0x777777, 100);
	}
	...
	function comportement()
	{
		...
		{ 
			...
			function modifierTailleAvecSouris(clip, taille)
			{
				...
				clip.setTailleRectangle(taille, mesPositions[0],  mesPositions[1]);
