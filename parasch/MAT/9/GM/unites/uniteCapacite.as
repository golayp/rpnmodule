...
class unite3 extends MovieClip
{
...
static var ceClip:MovieClip;
	...
	function unite3(tailleImageTemp, positionX, positionY,clipConteneur, utilisable, nomClipTemp)
	{
...
////////////////////////////ATTENTION ON NE PEUT PAS METTRE DE PNG DANS FLASH 6
		...
		paraRec(longueurBase, 1, 1, 1, 2, 0x777777, 0xFFAACC, 100);
	...
	function setTailleParaRec(maLongueur, X, Y, Z)
	{
		...
		paraRec(maLongueur, X, Y, Z, 2, 0x777777, 0xFFAACC, 100);
		//trace("coordonneeX = " + X);
		//trace("coordonneeY = " + Y);
		//trace("coordonneeZ = " + Z);
		//trace("")
