...
var couleurFlecheParcours:Number = 0xcc3300;//couleur de la flèche
...
function fleche(objetCase,type,orientation)
{
	...
	{
		case "chemin" :
		var couleurFleche : Number = couleurFlecheChemin;
		var couleurBordFleche : Number = couleurBordFlecheChemin;
		var epaisseurBordFleche : Number = epaisseurBordFlecheChemin;
		var no : Number = 6000 + noCase(posX, posY);
		break;
		case "parcours" :
		var couleurFleche : Number = couleurFlecheParcours;
		var couleurBordFleche : Number = couleurBordFlecheParcours;
		var epaisseurBordFleche : Number = epaisseurBordFlecheParcours;
		var no : Number = 5000 + noCase(posX, posY);
		break;
	}
	switch (orientation)
	{
	...
	//trace("this[flecheConstruiteSurChemin[i]]._name"+this[flecheConstruiteSurChemin[flecheConstruiteSurChemin.length-1]]._name);
	//trace("this[flecheConstruiteSurChemin[i]]._name.substring(4)"+this[flecheConstruiteSurChemin[flecheConstruiteSurChemin.length-1]]._name.substring(this[flecheConstruiteSurChemin[flecheConstruiteSurChemin.length-1]]._name.length-4));
}
	...
	switch (type)
	{
		case "chemin":
			for(i=0;i<flecheConstruiteSurChemin.length;i++)
			{
				...
				{
					//trace("this[flecheConstruiteSurChemin[i]]._name.substring(4)"+this[flecheConstruiteSurChemin[i]]._name.substring(this[flecheConstruiteSurChemin[i]]._name.length-4));
		...
		case "parcours":
			for(i=0;i<flecheConstruiteSurChemin.length;i++)
			{
				//trace("parcours"+this[flecheConstruiteSurChemin[i]]._name.substring(this[flecheConstruiteSurChemin[i]]._name.length-4));
