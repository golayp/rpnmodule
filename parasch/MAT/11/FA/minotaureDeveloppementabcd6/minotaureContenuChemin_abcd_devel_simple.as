...
for (i = 0; i < longueurChemin+1; i++)
{
	...
	maCase[no].operationChoisie(choixOperationH,tabHBJuste[posDepTab - i][0], tabHBJuste[posDepTab - i][1], tabHBJuste[posDepTab - i][4], tabHBJuste[posDepTab - i][5], "HAUT", texteHautpetit_fmt);
	maCase[no].operationChoisie(choixOperationB,tabHBJuste[posDepTab - i-1][0], tabHBJuste[posDepTab - i-1][1], tabHBJuste[posDepTab - i-1][4], tabHBJuste[posDepTab - i-1][5], "BAS", texteBaspetit_fmt);
...
for (c = 0 ; c < longueurChemin ; c++)
{
	...
	maCase[no].operationChoisie(choixOperationH,tabHBJuste[posDepTab - c][0], tabHBJuste[posDepTab - c][1], tabHBJuste[posDepTab - c][4], tabHBJuste[posDepTab - c][5], "HAUT", texteHautpetit_fmt);
	//variation(maCase[no],1, 2, 3, 4, choixOperationH, texteHautpetit_fmt);
	maCase[no].operationChoisie(choixOperationB,tabHBJuste[posDepTab - c][0], tabHBJuste[posDepTab - c][1], tabHBJuste[posDepTab - c][4], tabHBJuste[posDepTab - c][5], "BAS", texteBaspetit_fmt);
	...
	for (i = 2; i < longImpasse[c]+1 ; i++)
	{
		...
		maCase[no].operationChoisie(choixOperationH,tabHBJuste[posDepTab - c - i][0], tabHBJuste[posDepTab - c - i][1], tabHBJuste[posDepTab - c - i][4], tabHBJuste[posDepTab - c - i][5], "HAUT", texteHautpetit_fmt);
		maCase[no].operationChoisie(choixOperationB,tabHBJuste[posDepTab - c - i-1][0], tabHBJuste[posDepTab - c - i-1][1], tabHBJuste[posDepTab - c - i-1][4], tabHBJuste[posDepTab - c - i-1][5], "BAS", texteHautpetit_fmt);
...
maCase[no].operationChoisie(choixOperationH,tabHBJuste[posDepTab+ 1 - longueurChemin][0], tabHBJuste[posDepTab+ 1 - longueurChemin][1], tabHBJuste[posDepTab+ 1 - longueurChemin][4], tabHBJuste[posDepTab+ 1 - longueurChemin][5], "HAUT", texteHautpetit_fmt);
variation(maCase[no],tabHBJuste[posDepTab+ 1 - longueurChemin][0], tabHBJuste[posDepTab+ 1 - longueurChemin][1], tabHBJuste[posDepTab+ 1 - longueurChemin][4], tabHBJuste[posDepTab+ 1 - longueurChemin][5], choixOperationH, texteHautpetit_fmt);
maCase[no].operationChoisie(choixOperationB,tabHBJuste[posDepTab+ 1 - longueurChemin][0], tabHBJuste[posDepTab+ 1 - longueurChemin][1], tabHBJuste[posDepTab+ 1 - longueurChemin][4], tabHBJuste[posDepTab+ 1 - longueurChemin][5], "BAS", texteBaspetit_fmt);
...
for (i = 2; i < longImpasse[longueurChemin]+1 ; i++)
{
	...
	maCase[no].operationChoisie(choixOperationH,tabHBJuste[posDepTab - i][0], tabHBJuste[posDepTab - i][1], tabHBJuste[posDepTab - i][4], tabHBJuste[posDepTab - i][5], "HAUT", texteHautpetit_fmt);
	maCase[no].operationChoisie(choixOperationB,tabHBJuste[posDepTab - longueurChemin + i][0], tabHBJuste[posDepTab - longueurChemin + i][1], tabHBJuste[posDepTab - longueurChemin + i][4], tabHBJuste[posDepTab - longueurChemin + i][5], "BAS", texteHautpetit_fmt);
	...
	for (i = 1 ; i < nbCasesX+1 ; i++)
	{
		for (j = 1 ; j < nbCasesY+1 ; j++)
		{
			if (etatCase[i][j]=="")
			{
				...
				no = noCase(i, j);
				maCase[no].operationChoisie(choixOperationH,tabHBJuste[noAlea][0], tabHBJuste[noAlea][1], tabHBJuste[noAlea][4], tabHBJuste[noAlea][5], "HAUT", texteHautpetit_fmt);
				variation(maCase[no],tabHBJuste[noAlea][0], tabHBJuste[noAlea][1], tabHBJuste[noAlea][4], tabHBJuste[noAlea][5], choixOperationH, texteHautpetit_fmt);
				maCase[no].operationChoisie(choixOperationB,tabHBJuste[noAlea-1][0], tabHBJuste[noAlea-1][1], tabHBJuste[noAlea-1][4], tabHBJuste[noAlea-1][5], "BAS", texteBaspetit_fmt);
...
function testDoubleSorties()
{
	for (i = 0 ; i < longueurChemin ; i++)
	{
		...
		{
			maCase[no - nbCasesX].setTextH(tabHBJuste[posDepTab - i - 1][3], texteHautpetit_fmt);
			//maCase[no].commentaireCase=tabHBJuste[posDepTab - i - 1][4];
			maCase[no].operationChoisie(choixOperation,tabHBJuste[posDepTab - i - 1][0], tabHBJuste[posDepTab - i - 1][1], texteBaspetit_fmt);
		}
		...
		{
			maCase[no - 1].setTextH(tabHBJuste[posDepTab - i - 1][3], texteHautpetit_fmt);
			//maCase[no].commentaireCase=tabHBJuste[posDepTab - i - 1][4];
			maCase[no].operationChoisie(choixOperation,tabHBJuste[posDepTab - i - 1][0], tabHBJuste[posDepTab - i - 1][1], texteBaspetit_fmt);
		}
