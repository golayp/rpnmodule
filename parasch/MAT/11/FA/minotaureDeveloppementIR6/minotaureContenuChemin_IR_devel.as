...
for (c = 0 ; c < longueurChemin ; c++)
{
	...
	for (i = 2; i < longImpasse[c]+1 ; i++)
	{
		...
		maCase[no].operationChoisie(choixOperationB,tabHBJuste[posDepTab - c - i-1][0], tabHBJuste[posDepTab - c - i-1][1], tabHBJuste[posDepTab - c - i-1][4], tabHBJuste[posDepTab - c - i-1][5], "BAS", texteBaspetit_fmt);
