...
var maMontre:MovieClip = new heureDAvion(posCentre[0], posCentre[1], fondMc.angleMc, texteValeurH_fmt, texteValeurM_fmt, texteValeurTxt_fmt, texteSolution_fmt, dateMontre_fmt, [450, 360]);
...
fondMc.createTextField("arrivee", 7, posCentre2[0] - 20-(monMenu2.maLargeur + monMenu2.maHauteur) / 2, 50, 100, 20 );
...
fondMc.arrivee.text = "Arrivée à:";

fondMc.createTextField("arriveeLieu", 8, posCentre2[0] - 20-(monMenu2.maLargeur + monMenu2.maHauteur) / 2, 70, 20, 20 );
...
fondMc.createTextField("reponseH", 9, 55+posCentre2[0] - (monMenu2.maLargeur + monMenu2.maHauteur) / 2, 50, 30, 20 );
...
fondMc.createTextField("repH", 10, 85+posCentre2[0] - (monMenu2.maLargeur + monMenu2.maHauteur) / 2, 50, 15, 20 );
...
fondMc.createTextField("reponseM", 11, 100+posCentre2[0] - (monMenu2.maLargeur + monMenu2.maHauteur) / 2, 50, 35, 20 );
...
fondMc.createTextField("repM", 12, 135+posCentre2[0] - (monMenu2.maLargeur + monMenu2.maHauteur) / 2, 50, 100, 20 );
...
fondMc.createTextField("decalageHoraire", 13, 60+(posCentre2[0]-posCentre[0])/2, 95, 200, 20 );
...
fondMc.donnee2.text = "A quelle heure arrive-t-on à " +mesDestinationsArr[monArr] + " (heure locale) ?";
