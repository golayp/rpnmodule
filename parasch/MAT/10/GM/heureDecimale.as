...
class heureDecimale extends MovieClip
{
	...
	function heureDecimale(XTemp,YTemp, clipConteneur, formatHTemp, formatMTemp, formatTxtTemp, formatTxtSolTemp,formatDateMontreTemp, tailleSceneTemp)
	{
	...
	function dessineLeClip()
	{
		...
		conteneur.createTextField("infoLampe", 200, conteneur.lampePocheMc._x, conteneur.lampePocheMc._y, 75, 40);
		...
		conteneur.conteneurTxtReponse.background = true;
