...
//mouse_level0.listener.onMouseMove = function() {
	...
	if(tempsVol[fuseau1][fuseau2][1] !=0 && tempsVol[fuseau1][fuseau2][0] != 0){
		_level0.rep_juste = analyse(fondMc.reponseM.text, fondMc.reponseH.text, decaM, decaH, tempsVol[fuseau1][fuseau2][1], tempsVol[fuseau1][fuseau2][0]);
	}
...
*/
	...
	switch(true) {
		case (minArr == min && hArr == h):
			...
			//actionSolution();
			_level0.retour = "Bravo, on arrive bien "+monJour+"\nà "+hArr+"h "+minArr+"min.";
			break;
		case (minArr == min && hArr != h):
...
function actionSolution() {
	...
	if (fuseau1 > 0 && fuseau2 > 0){
		...
		//if (fuseau1 > 0 && fuseau2 > 0){
		//if (tempsVol[fuseau1][fuseau2][1] < 10 && tempsVol[fuseau1][fuseau2][1] > 0) {
		//	fondMc.tempsDeVol.text = "Temps de vol: " +tempsVol[fuseau1][fuseau2][0] + "h 0" + tempsVol[fuseau1][fuseau2][1] + "min";
		//}else {
		//	fondMc.tempsDeVol.text = "Temps de vol: " +tempsVol[fuseau1][fuseau2][0] + "h " + tempsVol[fuseau1][fuseau2][1] + "min";
		//}
		fondMc.tempsDeVol.text = "Temps de vol: " +tempsVol[fuseau1][fuseau2][0] + "h " + tempsVol[fuseau1][fuseau2][1] + "min";
