		...
		switch (position)
		{
			...
			switch (operationUtiliseeH)
			{
				...
				case ("factorise"):
					...
					//conteneur.carre.monAffichageFactoriseHaut.createTextField("factorise", 1, (mataille-30)/3, 0, 0, mataille*3/16+4);
					...
					switch (true)
					{
						...
						trace("b=0");
								...
								if (a==1){
									trace("a=1"+a);
									conteneur.carre.monAffichageFactoriseHaut.factorise.text="x(";
								}
								if(a!=1){
								...
								if(c==1){
									conteneur.carre.monAffichageFactoriseHaut.factorise.text=conteneur.carre.monAffichageFactoriseHaut.factorise.text+"x";
									trace("c=1"+c);
								}
								if (c!=1){
									conteneur.carre.monAffichageFactoriseHaut.factorise.text=conteneur.carre.monAffichageFactoriseHaut.factorise.text+c+"x";
									trace("c!=1");
								}
								if(d>0){
									conteneur.carre.monAffichageFactoriseHaut.factorise.text=conteneur.carre.monAffichageFactoriseHaut.factorise.text+"+"+d+")";
									trace("d>0");
								}
								if(d<=0){
									conteneur.carre.monAffichageFactoriseHaut.factorise.text=conteneur.carre.monAffichageFactoriseHaut.factorise.text+d+")";
...
//								break;
						...
						case (b==0):
							if(d>0)
							{
								conteneur.carre.monAffichageFactoriseHaut.factorise.text=a+"x("+c+"x+"+d+")";
							}else if (d<0)
							{
								conteneur.carre.monAffichageFactoriseHaut.factorise.text=a+"x("+c+"x"+d+")";
							}
				...
				case ("factorise"):
					...
					switch (true)
					{
						...
						trace("b=0");
							//if(d>0)
//							{
//								conteneur.carre.monAffichageFactoriseBas.factorise.text=a+"x("+c+"x+"+d+")";
//							}else if (d<0)
//							{
//								conteneur.carre.monAffichageFactoriseBas.factorise.text=a+"x("+c+"x"+d+")";
//							}else
//							{
//								conteneur.carre.monAffichageFactoriseBas.factorise.text=a+"x("+c+"x)";
//							}
								...
								if(c==1){
									conteneur.carre.monAffichageFactoriseBas.factorise.text=conteneur.carre.monAffichageFactoriseBas.factorise.text+"x";
									trace("c=1"+c);
								}
								if (c!=1){
									conteneur.carre.monAffichageFactoriseBas.factorise.text=conteneur.carre.monAffichageFactoriseBas.factorise.text+c+"x";
									trace("c!=1");
								}
								if(d>0){
									conteneur.carre.monAffichageFactoriseBas.factorise.text=conteneur.carre.monAffichageFactoriseBas.factorise.text+"+"+d+")";
									trace("d>0");
								}
								if(d<=0){
									conteneur.carre.monAffichageFactoriseBas.factorise.text=conteneur.carre.monAffichageFactoriseBas.factorise.text+d+")";
