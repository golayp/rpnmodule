...
class SurligneurEq
{
	...
	function SurligneurEq(mcFondTemp, couleurTemp, nomSurligneurTemp, xTemp, yTemp, cibleDonneeTemp, cibleSortieTemp, marquageTemp)
	{
	...
	public function init()
	{
		...
		mcSurligneur[nomSurligneur]._y=0;
		mcSurligneur._y = posY;
		mcSurligneurNom._x = 0;
		mcSurligneurNom._y = -2;
	...
	public function visibilite(choix) {
		//trace ("visibilite");
		mcSurligneur._visible = choix;
	}
