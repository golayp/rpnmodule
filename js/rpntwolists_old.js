...
var leftdiv, 
    ...
    var buildUi = function() {
       ...
       /* if(datas.rightitems.length<datas.leftitems.length){
            myCanvasPositionHeight=datas.rightitems.length*100;
        }else{
           myCanvasPositionHeight=datas.leftitems.length*100; 
        }*/
       ...
       // var myCanvas=$('<canvas id="c'+datas.idmodule+'"  width="1000px">'),
