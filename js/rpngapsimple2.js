...
var rpngapsimplemodule = function() {
    ...
    var buildUimath=function(){
        ...
        var mathdiv=MathJax.HTML.Element(
          ...
          ["Here is math: $$\\frac{2}{3}$$ $$\\frac{\\partial}{\\partial t} \\frac{4}{5}$$ \\(x+1\\)",["br"],"and a display $$x+1\\over (x-1)$$"]
        );
        maindiv.append(mathdiv);
        domelem.append(maindiv);
        console.log('dans buildUimath');
        //MathJax.Hub.Typeset();
        ...
        var contentmat=MathJax.HTML.Element("span",{class:"form-inline"},[datas.mathcontent]);
        //domelem.append(contentmat);
        domelem.append(($('<div class="form-inline"></div>').append(contentmat)).append(datas.tofill)) ;
