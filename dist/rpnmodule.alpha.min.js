...
var rpnmoduleLabels={en:{Recall:"Recall",Order:"Order",Warning:"Warning",BeforeUnloadMsg:"Module running!",Wait:"Wait please...",Validate:"Validate",Eraser:"Eraser"},fr:{Recall:"Rappel",Order:"Consignes",Warning:"Attention",BeforeUnloadMsg:"Exercice en cours!",Wait:"Veuillez patienter...",Validate:"Valider",Eraser:"Effaceur"}},rpnmoduleSelectedLabels,rpnmodule=function(){var c,e,d,g,b,a,h,f,k,n=function(){$("body").append($('<div class="container"><div class="row"><div class="col-md-12"><h1 id="sequenceTitle"></h1></div></div><div class="row"><div class="col-xs-8"><h2 id="moduleTitle"></h2><h3 id="moduleContext"></h3><h4 id="moduleDirective"></h4></div><div class="col-xs-4"><button class="btn btn-link" id="recallLink" data-toggle="modal" data-target="#recallModal">'+rpnmoduleSelectedLabels.Recall+
...
$("#sequenceTitle").html(c.title);d=$("#mainContent");h&&$(window).bind("beforeunload",function(a){return rpnmoduleSelectedLabels.BeforeUnloadMsg});l()},l=function(){var a=c.modules[e];_.defaults(a,{title:"title"});d.empty();d.removeClass().addClass("col-md-12");$("#moduleTitle").show().text(a.title);_.isUndefined(a.context)?$("#moduleContext").hide():$("#moduleContext").show().text(a.context);_.isUndefined(a.directive)?$("#moduleDirective").hide():$("#moduleDirective").show().text(a.directive);$("#waitModal").modal("hide");
"marker"==a.type?rpnmarkermodule.init(a,d):"mqc"==a.type?rpnmqcmodule.init(a,d):"gapsimple"==a.type?rpngapsimplemodule.init(a,d):"gapfull"==a.type?rpngapfullmodule.init(a,d):"clock"==a.type?rpnclockmodule.init(a,d):"blackbox"==a.type?rpnblackboxmodule.init(a,d):"dragdropsorting"==a.type&&rpndragdropsortingmodule.init(a,d)},q=function(){f(a);$.getJSON(g,function(f){var c=0;_.each(f.solutions,function(f,b){c+=_.isUndefined(a[b])?0:a[b].correctionFct(a[b].responses,f)});h&&$(window).unbind("beforeunload");
window.location=b})};return{init:function(d){_.defaults(d,{sequrl:"seq.json",solurl:"sol.json",mediaurl:"medias",returnurl:"../",warnonexit:!1,onsequenceend:function(){},onmoduleend:function(){},language:"en"});rpnmoduleSelectedLabels=rpnmoduleLabels[d.language];a=[];h=d.warnonexit;b=d.returnurl;g=d.solurl;f=d.onsequenceend;k=d.onmoduleend;$.getJSON(d.sequrl,function(a){_.defaults(a,{title:"mqc",modules:[]});c=a;e=0;n()})},buildUi:n,handleEndOfModule:function(f,b){a[e]={responses:f,correctionFct:b};
$("#waitModal").modal("show");e++;k(f);_.isUndefined(c.modules[e])?q():l()},genericValidateButton:function(a){_.isUndefined(a);return $("<button>",{"class":"btn btn-primary",text:" "+rpnmoduleSelectedLabels.Validate}).prepend($('<i class="glyphicon glyphicon-ok"></i>'))}}}(),rpnmarkermodule=function(){var c,e,d,g,b,a=function(){e.addClass("rpnmodule_marker");var a=$("<div>",{"class":"btn-group","data-toggle":"buttons"}),k=_.shuffle(["primary","success","info","warning","danger"]);a.append($('<label class="btn btn-default active"><input type="radio" name="options" id="option1" autocomplete="off" checked><i class="glyphicon glyphicon-pencil"></i> '+
rpnmoduleSelectedLabels.Eraser+"</label>").click(function(){d=-1}));$.each(c.markers,function(b,h){a.append($('<label class="btn btn-'+(k[b]||"default")+'"><input type="radio" name="options" id="option3" autocomplete="off"><i class="glyphicon glyphicon-pencil"></i> '+h.label+"</label>").click(function(){d=h.val}))});e.append(a);e.append($('<div id="sentences">'+c.tomark+"</div>"));$.each($("#sentences b"),function(a,f){b[a]=-1;var h=$(f);h.css("cursor","pointer").click(function(){h.removeClass();
-1!=d&&h.addClass("marker-"+k[d]);b[a]=d})});g=$("<button>",{"class":"btn btn-primary",text:" "+rpnmoduleSelectedLabels.Validate}).prepend($('<i class="glyphicon glyphicon-ok"></i>'));e.append(g);h()},h=function(){g.click(function(){rpnmodule.handleEndOfModule(b,function(a,b){var h=0;_.each(b,function(b,c){h+=a[c]==b?1:0});return h})})};return{init:function(h,k){_.defaults(h,{markers:[],tomark:["fill tomark to feel good please!"]});c=h;e=k;d=-1;b=[];a()}}}(),rpnmqcmodule=function(){var c,e,d,g,b=
function(){e.addClass("rpnmodule_mqc");var b=$("<ul>",{"class":"list-unstyled"});$.each(c.questions,function(a,d){g[a]=-1;var e=$("<li>");e.append($("<p>"+d.label+"</p>"));var l=$('<div class="btn-group" data-toggle="buttons">');$.each(c.answers,function(b,h){l.append($('<label class="btn btn-default"><input type="radio" name="question_'+a+'" id="answer_'+a+"_"+b+'" autocomplete="off">'+h.label+"</label>").click(function(){g[a]=b}));e.append(l)});b.append(e)});e.append(b);d=rpnmodule.genericValidateButton();
...
return{init:function(a,f){_.defaults(a,{inputtype:"number",fct:"x1",left:[1],right:[1]});c=a;e=f;g={left:[],right:[]};b()}}}(),rpndragdropsortingmodule=function(){var c,e,d,g,b=function(){e.addClass("rpnmodule_dnds");e.append($('<div class="row"><div class="container"><div class="col-md-12"><ol class="simple_with_drop"></ol></div></div><div class="row"><div class="container" id="dropzonecontainer"></div></div>'));$.each(c.drop,function(a,b){$("#dropzonecontainer").append($('<ol class="simple_with_drop"></ol>'))});
$("ol.simple_with_drop").sortable({group:"no-drop",handle:"i.icon-move"});d=rpnmodule.genericValidateButton();e.append(d);a()},a=function(){d.click(function(){$.each($(".blackbox-left"),function(a,b){g.left[a]=$(b).val()});$.each($(".blackbox-right"),function(a,b){g.right[a]=$(b).val()});rpnmodule.handleEndOfModule(g,function(a,b){var c=0;_.each(b.right,function(b,f){c+=a.right[f]==b?1:0});_.each(b.left,function(b,f){c+=a.left[f]==b?1:0});return c})})};return{init:function(a,f){_.defaults(a,{todrag:["empty"],
todrop:["empty too :'("]});c=a;e=f;g=[];b()}}}();
...
d&&[d.left,d.top];for(var f,g=a.length,e=[];g--;)f=a[g],e[g]=[g,b(f,c),d&&b(f,d)];return e=e.sort(function(a,b){return b[1]-a[1]||b[2]-a[2]||b[0]-a[0]})}function k(a){this.options=c.extend({},m,a);this.containers=[];this.options.rootGroup||(this.scrollProxy=c.proxy(this.scroll,this),this.dragProxy=c.proxy(this.drag,this),this.dropProxy=c.proxy(this.drop,this),this.placeholder=c(this.options.placeholder),a.isValidTarget||(this.options.isValidTarget=g))}function n(a,b){this.el=a;this.options=c.extend({},
q,b);this.group=k.get(this.options);this.rootGroup=this.options.rootGroup||this.group;this.handle=this.rootGroup.options.handle||this.rootGroup.options.itemSelector;var d=this.rootGroup.options.itemPath;this.target=d?this.el.find(d):this.el;this.target.on(l.start,this.handle,c.proxy(this.dragInit,this));this.options.drop&&this.group.containers.push(this)}var l,q={drag:!0,drop:!0,exclude:"",nested:!0,vertical:!0},m={afterMove:function(a,b,c){},containerPath:"",containerSelector:"ol, ul",distance:0,
...
pullPlaceholder:!0,serialize:function(a,b,d){a=c.extend({},a.data());if(d)return[b];b[0]&&(a.children=b);delete a.subContainers;delete a.sortable;return a},tolerance:0},p={},s=0,t={left:0,top:0,bottom:0,right:0};l={start:"touchstart.sortable mousedown.sortable",drop:"touchend.sortable touchcancel.sortable mouseup.sortable",drag:"touchmove.sortable mousemove.sortable",scroll:"scroll.sortable"};k.get=function(a){p[a.group]||(a.group===g&&(a.group=s++),p[a.group]=new k(a));return p[a.group]};k.prototype=
{dragInit:function(a,b){this.$document=c(b.el[0].ownerDocument);this.item=c(a.target).closest(this.options.itemSelector);this.itemContainer=b;!this.item.is(this.options.exclude)&&this.options.onMousedown(this.item,m.onMousedown,a)&&(this.setPointer(a),this.toggleListeners("on"),this.setupDelayTimer(),this.dragInitDone=!0)},drag:function(a){if(!this.dragging){if(!this.distanceMet(a)||!this.delayMet)return;this.options.onDragStart(this.item,this.itemContainer,m.onDragStart,a);this.item.before(this.placeholder);
this.dragging=!0}this.setPointer(a);this.options.onDrag(this.item,h(this.pointer,this.item.offsetParent()),m.onDrag,a);var b=a.pageX||a.originalEvent.pageX;a=a.pageY||a.originalEvent.pageY;var c=this.sameResultBox,d=this.options.tolerance;if(!c||c.top-d>a||c.bottom+d<a||c.left-d>b||c.right+d<b)this.searchValidTarget()||this.placeholder.detach()},drop:function(a){this.toggleListeners("off");this.dragInitDone=!1;if(this.dragging){if(this.placeholder.closest("html")[0])this.placeholder.before(this.item).detach();
else this.options.onCancel(this.item,this.itemContainer,m.onCancel,a);this.options.onDrop(this.item,this.getContainer(this.item),m.onDrop,a);this.clearDimensions();this.clearOffsetParent();this.lastAppendedItem=this.sameResultBox=g;this.dragging=!1}},searchValidTarget:function(a,b){a||(a=this.relativePointer||this.pointer,b=this.lastRelativePointer||this.lastPointer);for(var c=f(this.getContainerDimensions(),a,b),d=c.length;d--;){var e=c[d][0];if(!c[d][1]||this.options.pullPlaceholder)if(e=this.containers[e],
!e.disabled){if(!this.$getOffsetParent()){var k=e.getItemOffsetParent();a=h(a,k);b=h(b,k)}if(e.searchValidTarget(a,b))return!0}}this.sameResultBox&&(this.sameResultBox=g)},movePlaceholder:function(a,b,c,d){var f=this.lastAppendedItem;if(d||!f||f[0]!==b[0])b[c](this.placeholder),this.lastAppendedItem=b,this.sameResultBox=d,this.options.afterMove(this.placeholder,a,b)},getContainerDimensions:function(){this.containerDimensions||a(this.containers,this.containerDimensions=[],this.options.tolerance,!this.$getOffsetParent());
...
getContainerGroup:function(a){var b=c.data(this.items[a],"subContainers");if(b===g){var e=this.$getChildren(this.items[a],"container"),b=!1;e[0]&&(b=c.extend({},this.options,{rootGroup:this.rootGroup,group:s++}),b=e[d](b).data(d).group);c.data(this.items[a],"subContainers",b)}return b},$getChildren:function(a,b){var d=this.rootGroup.options,e=d[b+"Path"],d=d[b+"Selector"];a=c(a);e&&(a=a.find(e));return a.children(d)},_serialize:function(a,b){var d=this,e=this.$getChildren(a,b?"item":"container").not(this.options.exclude).map(function(){return d._serialize(c(this),
!b)}).get();return this.rootGroup.options.serialize(a,e,b)},traverse:function(a){c.each(this.items||[],function(b){(b=c.data(this,"subContainers"))&&b.traverse(a)});a(this)},_clearDimensions:function(){this.itemDimensions=g},_destroy:function(){var a=this;this.target.off(l.start,this.handle);this.el.removeData(d);this.options.drop&&(this.group.containers=c.grep(this.group.containers,function(b){return b!=a}));c.each(this.items||[],function(){c.removeData(this,"subContainers")})}};var r={enable:function(){this.traverse(function(a){a.disabled=
!1})},disable:function(){this.traverse(function(a){a.disabled=!0})},serialize:function(){return this._serialize(this.el,!0)},refresh:function(){this.traverse(function(a){a._clearDimensions()})},destroy:function(){this.traverse(function(a){a._destroy()})}};c.extend(n.prototype,r);c.fn[d]=function(a){var b=Array.prototype.slice.call(arguments,1);return this.map(function(){var e=c(this),f=e.data(d);if(f&&r[a])return r[a].apply(f,b)||this;f||a!==g&&"object"!==typeof a||e.data(d,new n(e,a));return this})}}(jQuery,
window,"sortable");
